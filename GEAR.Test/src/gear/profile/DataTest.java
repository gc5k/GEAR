...
public class DataTest
{
	...
	public void testPlinkData()
	{
		...
		gear.profile.Data data = new gear.profile.PlinkData(parser);
		...
		gear.profile.Data.Iterator iter = data.iterator();
	...
	public void testMachData()
	{
		...
		gear.profile.Data data = new MachData(dosageFiles, infoFiles);
