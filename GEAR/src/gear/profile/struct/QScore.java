	...
	public static QScore getNextQScore(BufferedReader reader)
	{
		...
		while (true)
		{
			...
			} else
			{
				try
				{
					qScore = new QScore(/* SNP = */tokens[0], /* q-score = */
							Double.parseDouble(tokens[1]));
				} catch (NumberFormatException e)
				{
					Logger.handleException(e, "Line " + reader.getCurLineNum()
							+ " of the q-score file '" + reader.getFileName()
							+ "' " + "contains an error: '" + tokens[1]
							+ "' is not a valid q-score.");
				}
			}
