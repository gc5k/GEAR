...
public class HERegBCommand extends Command 
{
	...
	{
		return "Bi-Haseman-Elston regression";
	}
	...
	public void prepareOptions(Options options) 
	{
		...
		options.addOption(OptionBuilder.withDescription(OPT_MPHE_DESC).hasArgs(2).create(OPT_MPHE));
	...
	private void parseGRMArguments(HERegBCommandArguments heArgs, CommandLine cmdLine) throws CommandArgumentException
	{
