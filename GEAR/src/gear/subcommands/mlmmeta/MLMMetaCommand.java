...
public class MLMMetaCommand extends Command
{
	public MLMMetaCommand()
	{
		addAlias("mlm-gm");
	}
	...
	public void prepareOptions(Options options)
	{
		...
		options.addOption(OptionBuilder.withDescription(OPT_MLM_DESC).withLongOpt(OPT_MLM_LONG).hasArg().create());
...
//		options.addOption(OptionBuilder.withDescription(OPT_GC_INFLATION_ONLY_LONG_DESC).withLongOpt(OPT_GC_INFLATION_ONLY_LONG).create(OPT_GC_INFLATION_ONLY));
	...
	{
		MLMMetaCommandArguments lamD = new MLMMetaCommandArguments();
...
//		}
		...
		if (cmdLine.hasOption(OPT_MLM_LONG))
		{
			lamD.setMLM(cmdLine.getOptionValue(OPT_MLM_LONG));
		}
	...
	private final static String OPT_MLM_LONG = "mlm-mat";
	private final static String OPT_MLM_DESC = "MLM matrix";
