...
public class MetaPCCommandArguments extends CommandArguments {
	...
	public void setCC(String[] cc) {
		...
		if ((ccSize.length / 2) != md.size()) {
			Logger.printUserLog("The cc sample size parameters [" + ccSize.length
					+ "] do not meet the length of the meta files [" + md.size() + "].");
			System.exit(0);
		}
	...
	public void setQT(String[] qt) {
		...
		if (qtSize.length != md.size()) {
			Logger.printUserLog("The qt sample size parameters [" + qtSize.length
					+ "] do not meet the length of the meta files [" + md.size() + "].");
			System.exit(0);
		}
	}
	...
	public void setKey(String[] k) {
		...
		// Logger.printUserLog("[INFO] The keyword for 'BP' (base pair) is set to " +
		// field[FConstant.BP]);
		// keyLen=6;
		// }
		//
		...
		// Logger.printUserLog("[INFO] The keyword for 'N' (sample size) is set to " +
		// field[FConstant.N]);
		// keyLen=7;
		// }
	}
	...
	public String toString() {
		...
		str.append("The keyword for 'MAF' (reference value for A1) is set to " + field[FConstant.Fvalue] + "\n");

		// if(keyLen > 5)
		// {
		// str.append("The keyword for 'BP' (base pair) is set to " +
		// field[FConstant.BP] + "\n");
		// }
		//
		// if(keyLen > 6)
		// {
		// str.append("The keyword for 'N' (sample size) is set to " +
		// field[FConstant.N] + "\n");
		// }
	...
	private String[] field = { "snp", "chr", "a1", "a2", "maf" };// , "or", "se", "p", };
