...
//			}
			...
			FStat ms = new FStat(tokens[KeyIdx[metaIdx][FConstant.SNP]], Float.parseFloat(tokens[KeyIdx[metaIdx][FConstant.Fvalue]]), tokens[KeyIdx[metaIdx][FConstant.A1]].charAt(0), tokens[KeyIdx[metaIdx][FConstant.A2]].charAt(0));
			if (KeyIdx[metaIdx][FConstant.CHR] != -1)
			{
