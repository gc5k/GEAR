...
public class WeightedMetaCommand extends Command {
	...
	public CommandArguments parse(CommandLine cmdLine) throws CommandArgumentException {
		WeightedMetaCommandArguments lamD = new WeightedMetaCommandArguments();
	...
	protected CommandImpl createCommandImpl() {
		return new WeightedMetaCommandImpl();
	}
	...
	// private final static String OPT_GC_INFLATION_ONLY_LONG_DESC = "genomic
	// control factor adjustment only for cohorts having lambda greater than 1";
