...
public abstract class AbstractGenoDistribution {
	 ...
	 * 
	 * @param child
	 *            , is a TreeMap object containing numbers of different
	 *            genotypes among the kids within the nuclear family.
	 */
	 ...
	 * @return String[]: nontrans_trans, the size is 2; nontran_tran[] =
	 *         {nontrans, trans} trans will be the same reference of transmitted
	 *         if transmitted is not missing and will be assigned a new referenc
	 *         of transmitted genotype if it is missing.
	 */
	...
	/**
	 * sometimes, the genotypes of parents are present; sometimes can be
	 * contructed from observed children genotype
	 */
	protected abstract void genotypeParents();

	/**
	 * @return true if both parental genotypes are available, or false
	 *         otherwise.
	 */
	...
	protected void Produce(String[] control, TreeMap<String, Integer> cM, String[] genopool, double[] freq) {
	...
	/**
	 * @return a String with randomly assigned genotype. When parental genotypes
	 *         are available, it's easy to randomly pick up an allele from each
	 *         parent. If only sib genotypes are available, randomly pick up a
	 *         genotype.
	 */
	...
	/**
	 * Put a nontransmitted genotype into TreeMap nontransmitted and count the
	 * number of each produced nontransmitted genotype.
	 * 
	 * @param genotype
	 */
	...
	public int get(String genotype) {
		if (nontransmitted.containsKey(genotype)) {
			return nontransmitted.get(genotype).intValue();
		} else {
			return -1;
		}
	}
	 ...
	 * @param genotype1
	 * @param genotype2
	 * @return a new genotype which is composed of the allele that are exclude.
	 *         For exmaple, f(12, 13)=23.
	 */
	public String ExtractUniqueAllele2Genotype(String genotype1, String genotype2) {
		String genotype;
