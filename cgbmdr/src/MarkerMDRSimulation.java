...
import mdr.heterogeneity.IMHeteroLinearCompleteMergeSearch;
 ...
 */
public class MarkerMDRSimulation {
...
//                        System.out.println(imh.peakStatistic());
            ...
            for (int i = search_start; i <= search_end; i++) {
                ...
                imh.setSearch(ssci, env);
                imh.search(i, pheNum[0]);
                Double t = new Double(threshold);
                double[] peakStats = null;
                Summary summary = new Summary(imh, peakStats);
                summary.significantpoint(t);
