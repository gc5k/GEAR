 ...
 * @author Guo-Bo Chen
 */
public class IF2Population extends AbstractPopulation {

    public IF2Population(int ps, int pheNum, String pt, double[][] d, long s, double mu, double[] env, double sd, ArrayList Q, int mf) {
            ...
            if (h == 0) {
                ...
                for (int i = 0; i < populationSize; i++) {
                    for (int f = 0; f < 2; f++) {
                        ...
                        for (int j = 0; j < marker_QTL[h * populationSize + i].length; j++) {
                            for (int k = 0; k < marker_QTL[h * populationSize + i][j].length; k++) {
                                marker_QTL[h * populationSize + i][j][k] = marker_QTL[i][j][k];
                            }
                        }
                    }
                }
