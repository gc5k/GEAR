...
//				int st=Math.random() < 0.5 ? 1:0;
    ...
    public void printGMDR(String TDTped, String TDTphe, String TDTPI, double[][] score, double[][] trait, ArrayList TDTTable, ArrayList PITable, int datatype, int pick, boolean trans, boolean nontrans) throws IOException {
        ...
        for (int i = 0; i < TDTTable.size(); i += 2) {
            if ((new Double(trait[i / 2][0])).intValue() == pick && datatype == 1) {
                continue;
            }
...
//////////////////////////////////////////////////////////////
            ...
            try {
                ...
                String TDTPI = new String("PI" + (new Integer(i)).toString() + ".txt");
...
//				double[][] sc = GD.pickupScore(PITable);
                ...
                simu.printGMDR(TDTPed, TDTPhe, TDTPI, res, trait, Table, PITable, datatype, pick, trans, nontrans);
